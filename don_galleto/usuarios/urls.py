...
from usuarios.views import  Lista_usuarios_view, Registro_admin_view, Edicion_usuario_view, eliminar_usuario, Login_view, Codigo_verificacion_view
urlpatterns = [
    ...
    path('codigo_verificacion/', views.Codigo_verificacion_view.as_view(), name='codigo_verificacion'),
]
