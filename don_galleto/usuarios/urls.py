...
from usuarios.views import  Lista_usuarios_view, Registro_admin_view, Edicion_usuario_view, eliminar_usuario, Login_view
from django.contrib.auth.decorators import login_required
urlpatterns = [
    ...
    path('my_login', views.Login_view.as_view(), name = 'mylogin' )
]
