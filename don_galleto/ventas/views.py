...
class Lista_Ventas_View(TemplateView):
    ...
    def get_context_data(self, **kwargs):
        ...
        # Procesamiento para pedidos con totales
...
class Generar_Venta_View(LoginRequiredMixin, FormView): 
    ...
    def form_valid(self, form):
        ...
        # Establecer el estatus según el tipo de venta
        ...
        # Verificar y procesar las galletas para la venta
        for i in range(len(galletas)):
            if galletas[i] and cantidades[i] and presentaciones[i]:
                ...
                if cantidad_vendida > galleta.cantidad:
                    # Si no hay suficiente inventario, detener la venta y redirigir
                    return redirect(self.success_url)  # Redirigir a la página de ventas
